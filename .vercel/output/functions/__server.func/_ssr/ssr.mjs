...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CHNGKsRd.mjs");
...
var manifest = { "ab61b8f2af6161b960ace87c70aa968477476c6ccec9e8bbe92b2918a4db4286": {
	functionName: "generateCopy_createServerFn_handler",
	importer: () => import("./ai-OYLAvs2N.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Ctk95bER.mjs").then((n) => n.t),
