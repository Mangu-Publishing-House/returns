...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Ctk95bER.js
...
var styles_default = "/assets/styles-B7szTqjK.css";
var APP_NAME = "MANGU Return";
...
var $$splitComponentImporter$2 = () => import("./routes-mdynvcF-.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./house-CSJZ0_Rw.mjs");
var Route$1 = createFileRoute("/house")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("../_id-Dr7sn2E1.mjs");
var Route = createFileRoute("/return/$id")({
	validateSearch: (s) => ({ step: typeof s.step === "string" ? s.step : void 0 }),
...
var rootRouteChildren = {
	...
	HouseRoute: Route$1.update({
		id: "/house",
		path: "/house",
		getParentRoute: () => Route$3
	}),
	ReturnIdRoute: Route.update({
		id: "/return/$id",
		path: "/return/$id",
		getParentRoute: () => Route$3
	})
